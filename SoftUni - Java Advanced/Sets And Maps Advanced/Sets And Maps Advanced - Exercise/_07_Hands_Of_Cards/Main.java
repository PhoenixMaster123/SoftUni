    ...
    public static void main(String[] args) {
        ...
        while (!input.equals("JOKER")) {
            ...
            */
            ...
            // Variant 3:
            /*points.putIfAbsent(name, new HashSet<>());
            for (String card : cards)
            {
                points.get(name).add(card);
            }

             */
           // Set<String> set = points.get(name);

            // Variant 4:
            points.computeIfAbsent(name, k -> new HashSet<>()).addAll(cards);

            // Add cards to the existing set -> for Variant 1 & 2
